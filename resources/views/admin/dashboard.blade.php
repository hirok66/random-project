                                    ...
                                    <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/products/3.png" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/products/7.png" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/products/8.png" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Accessories</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/products/9.png" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Gadgets</span>
                                    ...
                                    <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/users/user-3.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/users/user-7.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/users/user-8.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/users/user-9.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/users/user-10.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                                        <div>
