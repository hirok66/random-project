...
@section('content')
    <div class="container mt-3">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3>tage Management</h3>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add tage</button>
            </div>
    ...
    <div class="input-group" style="max-width: 300px;">
        ...
        <input type="text" id="search" class="form-control border-start-0 ps-0" placeholder="Search tages...">
    </div>
</div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody id="tageTableBody"> <!-- এখানে ডাটা লোড হবে -->
                        @include('admin.tages.table')
                    </tbody>
                </table>
                ...
                <div class="modal-content">
                    <form id="formData">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add tage</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="editData"> <!-- এডিট করার জন্য আলাদা আইডি -->
                ...
                <input type="hidden" id="edittageId" name="id">

                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit tage</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
    ...
    @section('footer')
                ...
                $('#formData').on('submit', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            Swal.fire({
                                title: "New tage Added Successfully",
                                icon: "success",
                                draggable: true
                            });
        ...
        function fetchData(page = 1, search = '') {
            $.ajax({
                ...
                success: function (response) {
                    $('#tageTableBody').html(response.table);
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                title: "Deleted!",
                                text: "The tage has been deleted.",
                                icon: "success"
                            });
