...
<!-- Mirrored from coderthemes.com/ubold/html/auth-2-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Jan 2026 08:57:16 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="mt-auto">
                            ...
                            <form class="mt-4" method="post" action="{{ route('login') }}">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="{{ route('password.request.form') }}" class="text-decoration-underline link-offset-3 text-muted">Forgot Password?</a>
                                </div>
