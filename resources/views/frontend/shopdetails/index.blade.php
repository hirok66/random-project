                                        ...
                                        <div class="row details_slider_nav">
                                            <div class="col-12">
                                                <div class="details_slider_nav_item">
                                                    <img src="{{asset('asset')}}/images/product_1-1.png" alt="Product"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_nav_item">
                                                    <img src="{{asset('asset')}}/images/product_1-2.png" alt="Product"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_nav_item">
                                                    <img src="{{asset('asset')}}/images/product_1-3.png" alt="Product"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_nav_item">
                                                    <img src="{{asset('asset')}}/images/product_1-4.png" alt="Product"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_nav_item">
                                                    <img src="{{asset('asset')}}/images/product_1-5.png" alt="Product"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_nav_item">
                                                    <img src="{{asset('asset')}}/images/product_1-6.png" alt="Product"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row details_slider_thumb">
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="{{asset('asset')}}/images/product_1-1.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="{{asset('asset')}}/images/product_1-2.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="{{asset('asset')}}/images/product_1-3.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="{{asset('asset')}}/images/product_1-4.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="{{asset('asset')}}/images/product_1-5.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="details_slider_thumb_item">
                                                    <img src="{{asset('asset')}}/images/product_1-6.png" alt="Dress"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="description3" role="tabpanel"
                                        ...
                                        <div class="shop_details_vendor">
                                            <div class="shop_details_vendor_logo_area">
                                                <div class="img">
                                                    <img src="{{asset('asset')}}/images/brand7.png" alt="Vendor" class="img-fluid">
                                                </div>
                                                <h3>
                                                    Zapier Gallery
                                                    <span>
                                        ...
                                        <div class="shop_details_review">
                                            ...
                                            <div class="single_review_list_area">
                                                ...
                                                <div class="single_review">
                                                    <div class="img">
                                                        <img src="{{asset('asset')}}/images/testimonial_img_2.jpg" alt="Reviews"
                                                            class="img-fluid w-100">
                                                    </div>
                                                    <div class="text">
                                                        <h5>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <img src="{{asset('asset')}}/images/product_13.png" alt="Image"
                                                                    class="img-fluid w-100">
                                                            </li>
                                                            <li>
                                                                <img src="{{asset('asset')}}/images/product_9.png" alt="Image"
                                                                    class="img-fluid w-100">
                                                            </li>
                                                            <li>
                                                                <img src="{{asset('asset')}}/images/product_20.png" alt="Image"
                                                                    class="img-fluid w-100">
                                                            </li>
                                                            <li>
                                                                <img src="{{asset('asset')}}/images/product_24.png" alt="Image"
                                                                    class="img-fluid w-100">
                                                            </li>
                                                            <li>
                                                                <img src="{{asset('asset')}}/images/product_6.png" alt="Image"
                                                                    class="img-fluid w-100">
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="single_review">
                                                    <div class="img">
                                                        <img src="{{asset('asset')}}/images/comment_1.png" alt="Reviews"
                                                            class="img-fluid w-100">
                                                    </div>
                                                    <div class="text">
                                                        <h5>Smith Jhon
                                                ...
                                                <div class="single_review">
                                                    <div class="img">
                                                        <img src="{{asset('asset')}}/images/comment_2.png" alt="Reviews"
                                                            class="img-fluid w-100">
                                                    </div>
                                                    <div class="text">
                                                        <h5>
