...
<div class="dashboard_content mt_100">
                        <h3 class="dashboard_title">Address List <a class="common_btn"
                                href="{{ route('address.add') }}">Add New</a></h3>
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineRadioAddress01">
                                                    <span>
                                                        ...
                                                        <span>{!! $addres->dividion->name !!} </span>
                                                        <span>{!! $addres->district->name !!} </span>
                                                        <span>{!! $addres->upazila->name !!} </span>
                                                        <span>{!! $addres->union->name !!} </span>
