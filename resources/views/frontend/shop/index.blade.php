                    ...
                    <div id="sticky_sidebar">
                        ...
                        <div class="shop_filter_area">
                            ...
                            <div class="sidebar_related_product">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('shop.details') }}" class="img">
                                            <img src="{{asset('asset')}}/images/product_18.png" alt="Product" class="img-fluid">
                                        </a>
                                        <div class="text">
                                            <p class="rating">
                                    ...
                                    <li>
                                        <a href="{{ route('shop.details') }}" class="img">
                                            <img src="{{asset('asset')}}/images/product_23.png" alt="Product" class="img-fluid">
                                        </a>
                                        <div class="text">
                                            <p class="rating">
                                                <i class="fas fa-star"></i>
                                    ...
                                    <li>
                                        <a href="{{ route('shop.details') }}" class="img">
                                            <img src="{{asset('asset')}}/images/product_13.png" alt="Product" class="img-fluid">
                                        </a>
                                        <div class="text">
                                            <p class="rating">
                                                <i class="fas fa-star"></i>
                                    ...
                                    <li>
                                        <a href="{{ route('shop.details') }}" class="img">
                                            <img src="{{asset('asset')}}/images/product_7.png" alt="Product" class="img-fluid">
                                        </a>
                                        <div class="text">
                                            <p class="rating">
                                                <i class="fas fa-star"></i>
                                    ...
                                    <div class="product_list_item product_item_2 product_item">
                                        <div class=" row align-items-center">
                                            <div class="col-md-5 col-sm-6 col-xxl-4">
                                                <div class="product_img">
                                                    ...
                                                    <ul class="btn_list">
                                                        <li>
                                                            <a href="#">
                                                                <img src="{{asset('asset')}}/images/compare_icon_white.svg"
                                            ...
                                            <div class="col-md-7 col-sm-6 col-xxl-8">
                                                <div class="product_text">
                                                    <a class="title" href="{{ route('shop.details') }}">Full Sleeve Hoodie
                                                        Jacket</a>
                                                    <p class="rating">
                                                        <i class="fas fa-star"></i>
                                                        <i class="fas fa-star"></i>
                                                    ...
                                                    <a class="common_btn" href="{{ route('shop.details') }}">add to cart <i
                                ...
                                <div class="col-6 col-xxl-10 col-sm-12">
                                    <div class="product_list_item product_item_2 product_item">
                                        <div class=" row align-items-center">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-xxl-8">
                                                <div class="product_text">
                                                    <a class="title" href="{{ route('shop.details') }}">Denim Jeans Pants For
                                                        Men</a>
                                                    <p class="rating">
                                                        <i class="fas fa-star"></i>
                                                        <i class="fas fa-star"></i>
