                    ...
                    <div class="col-12">
                        <div class="page_banner_text wow fadeInUp">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('flash.deals.page') }}">Flash Deals</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_7.png" alt="Product" class="img-fluid w-100">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_9.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_10.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_11.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_17.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
            ...
            <div class="row">
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_12.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_13.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_14.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_16.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
                ...
                <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                    <div class="product_item_2 product_item">
                        <div class="product_img">
                            <img src="{{asset('asset')}}/images/product_15.png" alt="Product" class="img-fluid w-100">
                            <ul class="discount_list">
