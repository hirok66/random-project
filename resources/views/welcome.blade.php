...
@section('content')
                                ...
                                <div class="col-xl-12">
                                    <div class="banner_slider_2 wow fadeInUp"
                                        ...
                                        <div class="banner_slider_2_text">
                                            ...
                                            <a class="common_btn" href="{{route('shop.details')}}">shop now <i
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-sm-3">
                        <div class="view_all_btn_area">
                            <a class="view_all_btn" href="{{route('shop.page')}}">View all</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 wow fadeInUp">
                                <div class="special_product_item">
                                    ...
                                    <div class="special_product_text">
                                        <a class="title" href="{{route('shop.details')}}">Men's premium formal pant</a>
                                        <span>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 wow fadeInUp">
                                <div class="special_product_item">
                                    ...
                                    <div class="special_product_text">
                                        <a class="title" href="{{route('shop.details')}}">Kids cotton Combo Set</a>
                                        <span>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 wow fadeInUp">
                                <div class="special_product_item">
                                    ...
                                    <div class="special_product_text">
                                        <a class="title" href="{{route('shop.details')}}">Men's trendy formal shoes</a>
                                        <span>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 wow fadeInUp">
                                <div class="special_product_item">
                                    ...
                                    <div class="special_product_text">
                                        <a class="title" href="{{route('shop.details')}}">Men's T-shirt combo set </a>
                                        <span>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 wow fadeInUp">
                                <div class="special_product_item">
                                    ...
                                    <div class="special_product_text">
                                        <a class="title" href="{{route('shop.details')}}">Women's T-shirt combo</a>
                                        <span>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 wow fadeInUp">
                                <div class="special_product_item">
                                    ...
                                    <div class="special_product_text">
                                        <a class="title" href="{{route('shop.details')}}">Men's Fashionable Hoodie</a>
                                        <span>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                ...
                                <div class="row">
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Denim 2 Quarter Pant</a>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Men's Denim combo set</a>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Denim Jeans Pants For Men</a>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Half Sleeve Tops for Women</a>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Sharee Petticoat For Women</a>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Jeans Pants For Women</a>
                                                <p class="price">$49.00 <del>$39.00</del></p>
                                                <p class="rating">
                                                    <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">cherry fabric western tops</a>
                                    ...
                                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3">
                                        <div class="product_item_2 product_item">
                                            ...
                                            <div class="product_text">
                                                <a class="title" href="{{route('shop.details')}}">Denim Shirt For Men</a>
                                                <p class="price">$40.00 <del>$48.00</del></p>
                                                <p class="rating">
                                                    <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                ...
                <div class="row mt_15">
                            ...
                            <div class="col-xl-4 col-sm-6 col-md-4 wow fadeInUp">
                                <div class="best_selling_product_item">
                                    <img src="{{asset('asset')}}/images/best_sell_pro_img_1.jpg" alt="best sell"
                                        class="img-fluid w-100">
                                    <div class="text">
                                        <a class="title" href="{{route('shop.details')}}">Men's trendy casual shoes</a>
                                        <p class="price">$89.00 <del>$12.00</del></p>
                                        <a class="buy_btn" href="{{route('shop.details')}}">buy now <i
                            ...
                            <div class="col-xl-4 col-sm-6 col-md-4 wow fadeInUp">
                                <div class="best_selling_product_item">
                                    <img src="{{asset('asset')}}/images/best_sell_pro_img_3.jpg" alt="best sell"
                                        class="img-fluid w-100">
                                    <div class="text">
                                        <a class="title" href="{{route('shop.details')}}">Men's Casual Winter Jacket</a>
                    ...
                    <div class="col-xl-5 wow fadeInRight">
                        <div class="best_selling_product_item_large">
                            ...
                            <div class="text">
                                <a class="title" href="{{route('shop.details')}}">Best Sales Discount And Offers</a>
                                <p class="price">$89.00 <del>$12.00</del></p>
                                <a class="common_btn" href="{{route('shop.details')}}">buy now <i
                                        class="fas fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt_15">
                    ...
                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                        <div class="product_item_2 product_item">
                            ...
                            <div class="product_text">
                                <a class="title" href="{{route('shop.details')}}">Comfortable Sports Sneakers</a>
                    ...
                    <div class="col-xl-1-5 col-6 col-md-4 col-xl-3 wow fadeInUp">
                        <div class="product_item_2 product_item">
                            ...
                            <div class="product_text">
                                <a class="title" href="{{route('shop.details')}}"> Kid's dresses for summer</a>
                    ...
                    <div class="col-xl-3 col-lg-4 wow fadeInLeft">
                        <div class="bundle_product_banner">
                            ...
                            <div class="text">
                                ...
                                <a class="common_btn" href="{{route('shop.details')}}">shop now <i class="fas fa-long-arrow-right"
                            ...
                            <div class="row mt_40 favourite_product_2_slider">
                                ...
                                <div class="col-xl-3 wow fadeInUp">
                                    <div class="product_item_2 product_item">
                                        ...
                                        <div class="product_text">
                                            <a class="title" href="{{route('shop.details')}}">Women denim jacket</a>
                                ...
                                <div class="col-xl-3 wow fadeInUp">
                                    <div class="product_item_2 product_item">
                                        ...
                                        <div class="product_text">
                                            <a class="title" href="{{route('shop.details')}}">Half Sleeve Jachket for Women</a>
        ...
        <section class="brand_2 mt_85">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-sm-3">
                        <div class="view_all_btn_area">
                            <a class="view_all_btn" href="{{ route('all.brand') }}">View all</a>
                        </div>
                    </div>
                </div>
                <div class="row mt_40">
   ...
   @endforeach
        ...
        ==========================-->
      <section class="subscription_2  mt_50 xs_mt_60" id="subscribe_section"  style="background: url({{asset('asset')}}/images/subscribe_2_bg.jpg);">
    <div class="container">
                ...
                <div class="subscription_2_text">
                    ...
                    @if(session('error'))
                        <div style=" margin-bottom:10px;">
                          <h4 style="color: rgb(238, 0, 0); margin-bottom:10px;">  {{ session('error') }}</h4>
                        </div>
                    @endif



                    <form action="{{ route('gest.subscriber') }}" method="post">
                        @csrf
